...
### 1. Acceptance criteria met and demo-able in browser
...
### 2. Pull request reviewed by at least one teammate
...
### 3. Lint and typecheck pass (GitHub Actions enforced)
...
### 4. Tests added or updated where applicable
...
### 5. Errors handled with a user-safe message and a log entry
...
### 6. Feature documented if it changes setup or behavior
